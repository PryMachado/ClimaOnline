package com.climaonline.climaonline.view
...
import com.climaonline.climaonline.R
import com.climaonline.climaonline.constantes.Const
import com.climaonline.climaonline.databinding.ActivityMainBinding
import com.climaonline.climaonline.model.Main
import com.climaonline.climaonline.services.Api
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onResume() {
        ...
        retrofit.weatherMap("Rio de Janeiro",Const.API_KEY).enqueue(object : Callback<Main>{
            override fun onResponse(call: Call<Main>, response: Response<Main>) {
                if (response.isSuccessful){
                    respostaServidor(response)
                }else{
